...
export default function TeaserShader({
  ...
  if (fallback) {
    return (
      <div className="absolute inset-0 flex items-center justify-center bg-[#0d0d0c]">
        <NextImage
          src="/brand/hngry-logo.png"
          alt="HNGRŸ — Drop 001 coming 20.07.2026, 20:15"
          width={1080}
          height={1080}
          priority
          className="logo-invert w-3/4 max-w-2xl"
        />
      </div>
    );
  }
