  ...
  return (
    <Link href={`/product/${product.slug}`} className="group block">
      <div className="relative aspect-square overflow-hidden bg-smoke">
        ...
        />
        <span className="absolute inset-x-0 bottom-0 translate-y-full bg-ink py-2 text-center font-mono text-[11px] tracking-[0.25em] text-bone transition-transform duration-300 group-hover:translate-y-0">
